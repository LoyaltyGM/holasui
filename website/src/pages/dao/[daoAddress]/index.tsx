...
const DetailDaoAddress: NextPage<IDaoAddressProps> = ({ daoAddress }) => {
  ...
  const BradcrumbsHeader = () => {
    return (
      <nav className="mt-24 hidden md:flex" aria-label="Breadcrumb">
  ...
  return status === EthosConnectStatus.NoConnection ? (
    ...
    <main
      className={classNames(
        "z-10 mt-32  flex min-h-[100vh] flex-col rounded-lg py-6 pl-2 pr-2 md:mt-14 md:min-h-[65vh] md:pl-16 md:pr-10 ",
      )}
    >
      {!isDaoLoading ? (
        <>
