  ...
  "max-h-[48px] min-h-[48px] flex items-center justify-center rounded-xl border-2 px-2 text-lg font-semibold ",
  {
    variants: {
      ...
      variant: {
        ...
        "button-secondary-purple": "button-secondary-purple",
        ...
        "button-primary-purple": "button-primary-purple",
        ...
        "popup-secondary-purple": "popup-secondary-purple",
        ...
        "popup-primary-purple": "popup-primary-purple",
